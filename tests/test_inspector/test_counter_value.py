...
def test_new_counter_value(inspector_counter, counter_new_value_setup):
...
def test_valid_counter_value(inspector_counter, counter_new_value_setup):
    counter = inspector_counter
    value = counter.get_current_value()
    counter.open_new_value_modal() \
        .set_new_value(value + 1)
...
def test_invalid_counter_value(inspector_counter,
                               value, counter_new_value_setup):
    counter = inspector_counter
    counter.open_new_value_modal()
...
def test_less_value(inspector_counter, counter_new_value_setup):
    counter = inspector_counter
