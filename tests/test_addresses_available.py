...
class TestAddressesAvailable:
    ...
    def test_addresses_available(self):
        ...
        self.driver.find_element(By.XPATH, Locator.counters_menu_item).click()
        self.driver.find_element(By.XPATH, Locator.counters_dropdown).click()
        WebDriverWait(self.driver, 5).until(expected_conditions.presence_of_element_located((By.CLASS_NAME, 'x_panel')))
        assert self.driver.find_element(By.XPATH, Locator.counters_addresses_list).is_displayed()
        time.sleep(2)
